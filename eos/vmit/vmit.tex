...
\texttt{Y\_C}, \texttt{Y\_L}
                   & $Y_C, Y_{L_e}$ & the fractions the mode fixed \\
\texttt{Y\_S}      & $Y_S = n_S/\nB$ & \emph{measured} on the solved flavour
                                       densities through the charge map, in
                                       every mode --- what the equilibrium
                                       populated, not what was requested \\
\midrule
