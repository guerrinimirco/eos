...
The refusal is itself a known conformance gap rather than a settled design:
the flag is defined by what it does \emph{not} cover, so under trapping it
should mean the two remaining flavours and be added, not refused. It is
recorded in \texttt{docs/DEFERRED.md} and is not this document's to fix.
