...
OUTPUT_DIR = str(REPO_ROOT / "output" / "sfhoalphabag_hybrid_outputs")
...
from eos.sfhoalphabag.mixed_phase_eos import (
...
def results_to_dict(results: list, eta_override: float = None) -> dict:
    ...
    data = {
        ...
        'sigma_H': [], 'omega_H': [], 'rho_H': [], 'phi_H': [],
        'mu_B_H': [], 'mu_C_H': [], 'mu_S_H': [], 'mu_B_Q': [], 'mu_C_Q': [], 'mu_S_Q': [],
        'P_total': [],
        'e_total': [], 's_total': [], 'f_total': [],
        'n_B_H': [], 'Y_C_H': [], 'Y_S_H': [], 'n_B_Q': [], 'Y_C_Q': [], 'Y_S_Q': [], 
        'Y_C_tot': [], 'Y_S_tot': [],
    }
    ...
    for r in results:
        ...
        if is_mixed:
            ...
            data['f_total'].append(getattr(r, 'f_total', r.e_total - r.T * r.s_total))
            data['n_B_H'].append(r.n_B_H)
            data['Y_C_H'].append(r.Y_C_H)
            data['Y_S_H'].append(r.Y_S_H)
            ...
            data['sigma_H'].append(r.sigma_H)
            data['omega_H'].append(r.omega_H)
            data['phi_H'].append(r.phi_H)
            data['rho_H'].append(r.rho_H)
        elif is_pure_H:
            data['chi'].append(0)
            data['mu_B_H'].append(r.mu_B)
            data['mu_C_H'].append(r.mu_C)
            data['mu_S_H'].append(r.mu_S)
            data['mu_B_Q'].append(0)
            data['mu_C_Q'].append(0)
            data['mu_S_Q'].append(0)
            data['P_total'].append(r.P_total)
            data['e_total'].append(r.e_total)
            data['s_total'].append(r.s_total)
            data['f_total'].append(getattr(r, 'f_total', r.e_total - r.T * r.s_total))
            data['n_B_H'].append(r.n_B)
            data['Y_C_H'].append(r.Y_C)
            data['Y_S_H'].append(r.Y_S)
            data['n_B_Q'].append(0)
            data['Y_C_Q'].append(0)
            data['Y_S_Q'].append(0)   
            data['Y_C_tot'].append(r.Y_C)
            data['Y_S_tot'].append(r.Y_S)
            data['sigma_H'].append(r.sigma)
            data['omega_H'].append(r.omega)
            data['phi_H'].append(r.phi)
            data['rho_H'].append(r.rho)
        elif is_pure_Q:
            data['chi'].append(1)
            data['mu_B_H'].append(0)
            data['mu_C_H'].append(0)
            data['mu_S_H'].append(0)
            data['mu_B_Q'].append(r.mu_B)
            data['mu_C_Q'].append(r.mu_C)
            data['mu_S_Q'].append(r.mu_S)
            data['P_total'].append(r.P_total)
            data['e_total'].append(r.e_total)
            data['s_total'].append(r.s_total)
            data['f_total'].append(getattr(r, 'f_total', r.e_total - r.T * r.s_total))  # Compute if not available
            data['n_B_H'].append(0)
            data['Y_C_H'].append(0)
            data['Y_S_H'].append(0)
            data['n_B_Q'].append(r.n_B)
            data['Y_C_Q'].append(r.Y_C)
            data['Y_S_Q'].append(r.Y_S)   
            data['Y_C_tot'].append(r.Y_C)
            data['Y_S_tot'].append(r.Y_S)
            data['sigma_H'].append(0)
            data['omega_H'].append(0)
            data['phi_H'].append(0)
            data['rho_H'].append(0)
