...
$K_{\mathrm{sym}}$   & $-88.86$ MeV & $9 \nsat^2\, E_{\mathrm{sym}}''(\nsat)$ \\
\bottomrule
\end{tabular}
\end{center}
%
No inverse map is implemented: unlike \texttt{eos.dd2} and \texttt{eos.sfho},
whose couplings reach the nuclear-matter parameters only through a field
solve, the ZL parameters are already close enough to them that a fit is a
matter of six one-dimensional relations rather than of new physics, and none
of the studies this model serves has needed one.
