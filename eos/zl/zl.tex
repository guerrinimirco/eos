...
nuclear-matter parameters:} \textbf{no route.} \texttt{nmp.invert\_nmp} and
\texttt{nmp.from\_nmp} raise \texttt{NotImplementedError} --- six couplings
against the five nuclear-matter parameters of the standard list leaves a
one-parameter family, and nothing in the literature singles out a member of it.
The docstring names the two ways to close it. \texttt{nmp.compute\_nmp} is the
